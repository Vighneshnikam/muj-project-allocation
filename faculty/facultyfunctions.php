...
if (isset($_POST['addproject'])) {
    ...
    $sql = "INSERT INTO project (p_id, pname, pdesc, fid, max_student, no_of_student_allocated, semester, project_domain_type)
            VALUES ('$p_id', '$pname', '$pdesc', '$fid', '$max_student', 0, '$semester', '$domain_type')";
...
if (isset($_POST['update'])) {
    ...
    $update_query = "UPDATE project SET pname = '$pname', pdesc = '$pdesc', project_domain_type = '$domain_type', semester = '$semester', max_student = '$max_no_of_student' WHERE p_id = '$p_id'";
