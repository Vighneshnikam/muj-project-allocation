        ...
        <h3 class="card-title mt-3 text-center" style="color:rgb(236, 76, 8); font-weight:bold">    Faculty Login</h3>
          ...
          <div class="form-group">
            <div class="input-group mb-3">
                <input type="password" class="form-control" id="facultyLoginPassword" name="password" required placeholder="Password">
                <span class="input-group-text" onclick="togglePassword('facultyLoginPassword', this)" style="cursor:pointer;">
                    <i class="fa fa-eye"></i>
                </span>
            </div>
