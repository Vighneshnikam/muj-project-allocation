...
<head>
    ...
    <meta name="description" content="Faculty Add Project - Project Management Website">
    <meta name="keywords" content="faculty, add project, project, management, student">
    <meta name="author" content="Your Name">
    <title>Faculty Add Project</title>
...
<!-- <img src="../photo/avatar.png" alt="Faculty Avatar" style="display:none;" /> -->
...
$query = "SELECT * FROM project WHERE fid = '" . $_SESSION['fid'] . "'";
$result = $con->query($query);
if (!$result) {
    echo "<div style='color:red; text-align:center; margin:2rem;'>Query Failed: " . $con->error . "</div>";
    $result = false; // Prevent further errors
}
