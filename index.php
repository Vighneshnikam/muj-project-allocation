...
<meta name="title" content="Muj Project Allocation" />
  ...
  <meta name="description" content="Project Management Website for Students and Faculty">
    <meta name="keywords" content="project, management, student, faculty, dashboard">
...
<body>
<?php
// Removed breadcrumbs and search bar from homepage
?>
<!-- Example image with alt text -->
<img src="photo/avatar.png" alt="User Avatar" style="display:none;" />
...
<footer style="margin-top:2rem; padding:2rem 1rem; background:#222; color:#fff; text-align:center;">
  <div style="margin-bottom:1rem;">
    <a href="privacy-policy.php" style="color:#fff; text-decoration:underline; margin:0 10px;">Privacy Policy</a>
    |
    <a href="terms-of-service.php" style="color:#fff; text-decoration:underline; margin:0 10px;">Terms of Service</a>
  </div>
  <div style="max-width:600px; margin:2rem auto 0 auto;">
    <h3 style="font-weight:600; letter-spacing:1px; color:#ff7700; margin-bottom:1rem;">What Our Users Say</h3>
    <div style="display:flex; flex-wrap:wrap; justify-content:center; gap:2rem;">
      <div style="background:#fff; color:#222; border-radius:10px; box-shadow:0 2px 8px rgba(0,0,0,0.08); padding:1.5rem; max-width:260px; min-width:200px; margin-bottom:1rem;">
        <div style="font-size:1.1rem; font-style:italic; margin-bottom:1rem;">“This platform made managing my projects so much easier!”</div>
        <div style="font-weight:600; color:#ff7700;">- Student User</div>
      </div>
      <div style="background:#fff; color:#222; border-radius:10px; box-shadow:0 2px 8px rgba(0,0,0,0.08); padding:1.5rem; max-width:260px; min-width:200px; margin-bottom:1rem;">
        <div style="font-size:1.1rem; font-style:italic; margin-bottom:1rem;">“A must-have tool for faculty and students alike.”</div>
        <div style="font-weight:600; color:#ff7700;">- Faculty Member</div>
      </div>
    </div>
  </div>
  <div style="margin-top:2rem; font-size:0.95rem; color:#bbb;">&copy; 2024 Project Management Website. All rights reserved.</div>
</footer>
<div id="cookie-banner" style="position:fixed;bottom:0;width:100%;background:#222;color:#fff;padding:1rem;text-align:center;z-index:9999;">
  This website uses cookies to ensure you get the best experience.
  <button onclick="document.getElementById('cookie-banner').style.display='none';" style="margin-left:1rem;">OK</button>
</div>
<script>
  if (localStorage.getItem('cookieAccepted')) {
    document.getElementById('cookie-banner').style.display = 'none';
  }
  document.querySelector('#cookie-banner button').onclick = function() {
