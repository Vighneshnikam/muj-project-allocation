...
<form method="POST">
          ...
          <div class="form-group">
            <div class="input-group mb-3">
                <input type="password" class="form-control" id="adminLoginPassword" name="password" required placeholder="Password">
                <span class="input-group-text" onclick="togglePassword('adminLoginPassword', this)" style="cursor:pointer;">
                    <i class="fa fa-eye"></i>
                </span>
            </div>
