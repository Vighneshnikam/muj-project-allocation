  ...
  <div id="chatbot-interface" class="chatbot-interface">
    <div class="chatbot-header">
      ...
      <div class="chatbot-controls">
        <button id="chatbot-expand" class="chatbot-control-btn">
      ...
      <div class="bot-message">
        ...
        <div class="message-bubble">
          <div class="message-content">
            Hello! I'm your project assistant. I can help you find project ideas or answer questions about your current projects. What can I help you with today?
          </div>
